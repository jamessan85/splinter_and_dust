"""
Django settings for splinter_an_dust project.
...
WSGI_APPLICATION = 'splinter_and_dust.wsgi.application'
...
STATIC_URL = '/static/'
#static file route deployement to heroku - generates the folder when site uploaded.
...
AUTH_USER_MODEL = 'tradelogins.User'
